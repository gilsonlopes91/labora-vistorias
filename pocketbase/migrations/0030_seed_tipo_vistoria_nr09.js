  ...
  (app) => {
    ...
    try {
      tipoRec = app.findFirstRecordByFilter(
        'tipos_vistoria',
        "nr_referencia = 'NR-09' && organizacao_id = ''",
      )
    } catch (_) {
      ...
      tipoRec.set(
        'descricao',
        'Checklist oficial da NR-09 (corpo da norma, Anexo I - Vibração e Anexo III - Calor), com itens ' +
          'e classificação (grau/tipo) extraídos do Anexo II da NR-28. Cálculo de multa pelo Anexo I da NR-28.',
      )
